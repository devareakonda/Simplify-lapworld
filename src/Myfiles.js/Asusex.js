  ...
  return (
   <div>
         <div className="container-fluid p-2">
            <h1 className="text-white m-5 text-center">Asus Laptops</h1>
            <div className="row">
                {
                    data.map((item, index)=>{
                        return(
            ...
            <NavLink to="/Asusex"><button className='seemore  text-center flex-center' >See More</button></NavLink>
        </div>
    </div>
  )
}

export default Asusex